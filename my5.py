...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1766, 1005)
        MainWindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.saveBTN = QtWidgets.QPushButton(self.centralwidget)
        self.saveBTN.setGeometry(QtCore.QRect(740, 950, 151, 31))
        font = QtGui.QFont()
        ...
        self.TransX_slider.setGeometry(QtCore.QRect(300, 700, 861, 16))
        ...
        self.TransY_slider.setGeometry(QtCore.QRect(300, 740, 861, 16))
        ...
        self.RotX_slider.setGeometry(QtCore.QRect(300, 820, 861, 16))
        ...
        self.RotY_slider.setGeometry(QtCore.QRect(300, 860, 861, 16))
        ...
        self.RotZ_slider.setGeometry(QtCore.QRect(300, 900, 861, 16))
        ...
        self.TransX_label.setGeometry(QtCore.QRect(200, 690, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        ...
        self.TransY_label.setGeometry(QtCore.QRect(200, 730, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        ...
        self.RotX_label.setGeometry(QtCore.QRect(200, 810, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        ...
        self.RotY_label.setGeometry(QtCore.QRect(200, 850, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        ...
        self.RotZ_label.setGeometry(QtCore.QRect(200, 890, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        ...
        self.label.setGeometry(QtCore.QRect(80, 700, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 740, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(80, 820, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(80, 860, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.label_5.setGeometry(QtCore.QRect(80, 900, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.updateBTN.setGeometry(QtCore.QRect(350, 950, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.TransY_slider_2.setGeometry(QtCore.QRect(300, 780, 861, 16))
        ...
        self.label_11.setGeometry(QtCore.QRect(80, 780, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        ...
        self.TransZ_label.setGeometry(QtCore.QRect(200, 770, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
    ...
    def update(self):
        self.update_PNG_contour = vtk.vtkDiscreteMarchingCubes()
        self.update_PNG_contour.SetInputConnection(self.PNG_Reader_1.GetOutputPort())
        self.update_PNG_contour.ComputeNormalsOn()
        self.update_PNG_contour.SetValue(0, 255)

        self.updatePNG_sinc = vtk.vtkWindowedSincPolyDataFilter()
        self.updatePNG_sinc.SetInputConnection(self.update_PNG_contour.GetOutputPort())
        self.updatePNG_sinc.SetNumberOfIterations(50)
        self.updatePNG_sinc.SetPassBand(0.003)

        updatePNG_transform = vtk.vtkTransform()
        updatePNG_transform.RotateWXYZ(self.RotX_slider.value(), 1, 0, 0)
        updatePNG_transform.RotateWXYZ(-(self.RotY_slider.value()), 0, 1, 0)
        updatePNG_transform.RotateWXYZ(self.RotZ_slider.value(), 0, 0, 1)

        updatePNG_transformFilter = vtk.vtkTransformPolyDataFilter()
        updatePNG_transformFilter.SetInputConnection(self.updatePNG_sinc.GetOutputPort())
        updatePNG_transformFilter.SetTransform(updatePNG_transform)
        updatePNG_transformFilter.Update()

        update_PNG_mapper = vtk.vtkPolyDataMapper()
        update_PNG_mapper.SetInputConnection(updatePNG_transformFilter.GetOutputPort())
        update_PNG_mapper.ScalarVisibilityOff()

        update_PNG_actor = vtk.vtkActor()
        update_PNG_actor.SetMapper(update_PNG_mapper)

        update_PNG_renderer = vtk.vtkRenderer()
        update_PNG_renderer.SetBackground([0.1, 0.1, 0.1])
        update_PNG_renderer.AddActor(update_PNG_actor)
        ...
        self.ren_1.AddActor(update_PNG_actor)
        self.ren_1.ResetCamera()
        self.iren_1.Initialize()
        self.iren_1.Start()
